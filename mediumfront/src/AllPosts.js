...
const AllPosts = () => {
    ...
    const handleFilteredPosts = () => {
        if (!filterBy || filterBy == null) {
            alert("Please select which property you want to Search");
        }
        const filtered = posts.filter((post) => {
            ...
            } else if (filterBy === "topic" && searchInput) {
    ...
    return (
        <div className='component-container'>
            ...
            <div>
                ...
                <button style={{ margin: "2px" }} onClick={handleFilteredPosts}>Search</button>
                ...
                <label>Filter posts created on or after this date</label>
